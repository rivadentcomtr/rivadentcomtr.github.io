(function ($) {
    ...
    $(document).on("submit", "#infoCommentsAdd", function (event) {
    ...
    $(document).on("submit", "#infoCommentsUpdate", function (event) {
        event.preventDefault();
        var btn = $(this).find('button[type="submit"]');
        btn.attr('disabled', true);
        var serialized = $(this).serializeArray();
    ...
    $(".delete-comment").jConfirm().on('confirm', function (e) {
        var id = $(this).data("id");
        var data = [
            {
                name: 'csrf',
    ...
    function saveNewPositions() {
        ...
        $.ajax({
            ...
            url: url + 'Comments/update_position',
            success: function(result) {
                if (result.status === true) {
