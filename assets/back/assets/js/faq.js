(function ($) {
    ...
    $(document).on("submit", "#infoFaqAdd", function (event) {
    ...
    $(document).on("submit", "#infoFaqUpdate", function (event) {
        event.preventDefault();
        var btn = $(this).find('button[type="submit"]');
        btn.attr('disabled', true);
        var serialized = $(this).serializeArray();
    ...
    $(".delete-faq").jConfirm().on('confirm', function (e) {
        var id = $(this).data("id");
        var data = [
            {
                name: 'csrf',
