(function ($) {
    ...
    $(document).on("submit", "#infoReferencesAdd", function (event) {
    ...
    $(document).on("submit", "#infoReferencesUpdate", function (event) {
        event.preventDefault();
        var btn = $(this).find('button[type="submit"]');
        btn.attr('disabled', true);
        var serialized = $(this).serializeArray();
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: serialized,
            url: url + 'References/update_ajax',
            success: function (result) {
                if (result.status === true) {
                    Swal.fire({
    ...
    function saveNewPositions() {
        ...
        $.ajax({
            ...
            url: url + 'References/update_position',
            success: function(result) {
                window.location.reload();
            },
            error: function() {
    ...
    function saveNewPositions2() {
        ...
        $.ajax({
            ...
            url: url + 'References/update_position_images',
            success: function(result) {
                window.location.reload();
            },
            error: function() {
    ...
    $('.gallery-img-delete').jConfirm().on('confirm', function (e) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: url + 'References/delete_images',
            success: function (result) {
                if (result.status === true) {
                    $('#del-' + id).remove();
                    Swal.fire({
