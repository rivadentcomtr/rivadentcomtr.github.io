(function ($) {
    ...
    $(document).on("submit", "#infoTreatmentAdd", function (event) {
    ...
    $(document).on("submit", "#infoTreatmentUpdate", function (event) {
        event.preventDefault();
        var btn = $(this).find('button[type="submit"]');
        btn.attr('disabled', true);
        var serialized = $(this).serializeArray();
    ...
    $(".treatment-status").change(function () {
        var id = $(this).data("id");
    ...
    $(".delete-treatment").jConfirm().on('confirm', function (e) {
        var id = $(this).data("id");
        var data = [
            {
                name: 'csrf',
    ...
    function saveNewPositions() {
        ...
        $.ajax({
            ...
            url: url + 'Treatment/update_position',
            success: function(result) {
                if (result.status === true) {
