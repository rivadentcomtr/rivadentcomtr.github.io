(function ($) {
    ...
    $(document).on("submit", "#infoBlogAdd", function (event) {
    ...
    $(document).on("submit", "#infoBlogUpdate", function (event) {
        event.preventDefault();
        var btn = $(this).find('button[type="submit"]');
        btn.attr('disabled', true);
        var serialized = $(this).serializeArray();
    ...
    $(".remove-ticket").jConfirm().on('confirm', function(e){
        var id = $(this).data("id");
        var data = [
            {
                name: 'csrf',
    ...
    $(document).on("submit", "#infoProjectTickets", function(event){
        event.preventDefault();
        var btn = $(this).find('button[type="submit"]');
        btn.attr('disabled', true);
        var serialized = $(this).serializeArray();
