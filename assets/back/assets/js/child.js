(function ($) {
    ...
    $(document).on("submit", "#infoChildAdd", function (event) {
    ...
    $(document).on("submit", "#infoChildUpdate", function (event) {
        event.preventDefault();
        var btn = $(this).find('button[type="submit"]');
        btn.attr('disabled', true);
        var serialized = $(this).serializeArray();
    ...
    $(".delete-child").jConfirm().on('confirm', function (e) {
        var id = $(this).data("id");
        var data = [
            {
                name: 'csrf',
